...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if rank == 0:
            ...
            if val_metrics:
                print(f"  Val   - Fused: AUC={val_metrics.get('fused_auc', 0):.4f}, ACC={val_metrics.get('fused_accuracy', 0):.4f}")
                print(f"          CM: AUC={val_metrics.get('cm_auc', 0):.4f}, ACC={val_metrics.get('cm_accuracy', 0):.4f}")
                print(f"          AO: AUC={val_metrics.get('ao_auc', 0):.4f}, ACC={val_metrics.get('ao_accuracy', 0):.4f}")
                print(f"          VO: AUC={val_metrics.get('vo_auc', 0):.4f}, ACC={val_metrics.get('vo_accuracy', 0):.4f}")
